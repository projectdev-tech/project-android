...
public class Keranjang2Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        notificationIconNavbar.setOnClickListener(v -> {
            Intent intent = new Intent(Keranjang2Activity.this, MenuNotifikasi.class);
        ...
        btnBeranda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Keranjang2Activity.this, BerandaActivity.class);
                startActivity(intent);
                finish(); // Optional
            }
        });
